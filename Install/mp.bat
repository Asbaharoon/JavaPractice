...
copy c:\javapractice\template\src\template.java  c:\javapractice\%1\src\%1.java
...
c:\tools\bin\sed s/Template/%1/ c:\JavaPractice\Template\src\Template.java > c:\JavaPractice\%1\src\%1.java
